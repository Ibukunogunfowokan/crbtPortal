...
// Other headers (method, content-type, etc.)
...
$query = "SELECT full_name FROM users WHERE id = '$current_user_id'";
$result = $conn->query($query);

if (!$result || $result->num_rows === 0) {
    log_action("Failed to fetch full_name for user $current_user_id");
